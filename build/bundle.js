...
/***/ function(module, exports, __webpack_require__) {
	...
	var getAllTags = function getAllTags(people) {
	  return _.uniq(people.reduce(function (tags, p) {
	    return tags.concat(p.tags || []);
	  }, [])).sort(function (a, b) {
	    return a.toLowerCase() < b.toLowerCase() ? -1 : 1;
	  });
	};

	var getTagElement = function getTagElement(tag, onClick) {
	  var div = document.createElement('div');

	  div.className = 'tag';
	  div.innerHTML = tag;
	  div.onclick = function (e) {
	    return onClick(e, div);
	  };

	  return div;
	};

	var getTagElements = function getTagElements(tags, onClick) {
	  var tagElements = tags.map(function (tag) {
	    return getTagElement(tag, function (e, tagElement) {
	      e.preventDefault();

	      var cl = tagElement.classList;
	      var isAdding = !cl.contains('active');
	...
	var getStatHTML = function getStatHTML(stat) {
	  stat = stat || {};
	...
	var getCardElements = function getCardElements(people) {
	  return people.map(getCardElement);
	};

	var makeHeaderFixed = function makeHeaderFixed() {
	...
	var render = function render() {
	  ...
	  getCardElements(people).forEach(function (card) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if ( true ) {
	  // AMD
	  !(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(5) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (defineBridget), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	...
	module.exports = [
		{
			...
			"email": "ashley.alexander@airbnb.com",
			"firstName": "Ashley",
			"lastName": "Alexander",
		...
		},
		{
			...
			"stats": [
				...
				{
					"label": "Dogs Followed on Instagram",
					"value": "82"
				},
				{
		...
		},
		{
			"animal": "Racoon",
			"base": "San Francisco, CA",
			"email": "poyan.pourshian@airbnb.com",
			"firstName": "Poyan",
			"lastName": "Pourshian",
		...
		},
		{
			"animal": "Eagle",
			"base": "San Francisco, CA",
			"email": "manuel.deschamps@airbnb.com",
			"firstName": "Manuel",
			"lastName": "Deschamps",
		...
		},
		{
			"animal": "Dolphin",
			"base": "San Francisco, CA",
			"email": "ram.subbaroyan@airbnb.com",
			"firstName": "Ram",
			"lastName": "Subbaroyan",
		...
		},
		{
			"animal": "Panther",
			"base": "San Francisco, CA",
			"email": "shashank.dabriwal@airbnb.com",
			"firstName": "Shashank",
			"lastName": "Dabriwal",
		...
		},
		{
			...
			"stats": [
				...
				{
					"label": "Desk Moved during last job",
					"value": "8"
				},
				{
		...
		},
		{
			"animal": "Panda",
			"base": "San Francisco, CA",
			"email": "fatemeh.alavizadeh@airbnb.com",
			"firstName": "Fatemeh",
			"lastName": "Alavizadeh",
